...
public class ApiRegionConnection {
	...
	public static ApiRegionConnection downloadData(String tp) throws MalformedURLException, IOException, JSONException {
	        ...
	        for (int i = 0; i < regions.length(); i++) {
	        	...
	        	if (jsonRegions.has("img")) {
	        		...
	        		{
	        			image = "http://sca-events.s3.amazonaws.com"+jsonImage.getString("big");
	        		}
				}
